...
export const ERROR = {
	...
	INVALID_AMOUNT_LENGTH: "!(_utilizedERC20s.length == _utilizedERC20Amount.length)",
	INVALID_BALANCE: "!(balanceOf(msg.sender) >= _ERC20Amount)",
	INVALID_PURPOSE_LENGTH: "__utilizedERC20.length != _purpose.length",
	INVALID_UTILIZED_ERC20_AMOUNT: "!(_utilizedERC20_utilization[_utilizedERC20s[i]].allocation == utilizedERC20AmountAllocationActual)",
