...
export const ERROR = {
	REGISTRY: {
		...
		EMP_STRATEGY_DEPLOYER_IS_ADDRESS_ZERO: "__v1EMPStrategyDeployer == address(0)",
		EMP_DEPLOYER_IS_ADDRESS_ZERO: "__v1EMPDeployer == address(0)",
		EMP_UTILITY_IS_ADDRESS_ZERO: "__v1EMPUtility == address(0)",
		ERC20_ADDRESS_ZERO: "_eRC20 == address(0)",
		ERC20_PRICE_ZERO: "utilizedERC20ETHValue == 0",
		ETH_VALUE_PROVIDER_ADDRESS_ZERO: "_eRC20ETHValueProvider == address(0)",
		GOVERNANCE_IS_ADDRESS_ZERO: "__governance == address(0)",
		STRATEGY_UTILITY_IS_ADDRESS_ZERO: "__v1EMPStrategyUtility == address(0)",
	...
	EMP_UTILITY: {
		...
		UTILIZED_V1_EMP_STRATEGY_INVALID_ALLOCATION: "utilizedV1EMPStrategyAllocationTotal != _I_V1_EMP_REGISTRY.PERCENT_ONE_HUNDRED()",
	...
	STRATEGY: {
		...
		INVALID_BALANCE: "eMP_shares[msg.sender] < _shares",
		INVALID_UTILIZED_ERC20: "_utilizedERC20[i] == address(0)",
		INVALID_PARAMS_DEPOSIT_LENGTH: "utilizedERC20.length != _utilizedERC20Amount.length",
	...
	STRATEGY_UTILITY: {
		...
		INVALID_ERC20_ALLOCATION_TOTAL: "utilizedERC20AllocationTotal != _I_V1_EMP_REGISTRY.PERCENT_ONE_HUNDRED()",
