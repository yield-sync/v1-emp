...
export const ERROR = {
	REGISTRY: {
		ARRAY_UTILITY_NOT_SET: "!(v1EMPArrayUtility != address(0))",
		EMP_UTILITY_NOT_SET: "!(v1EMPAmountsValidator != address(0))",
		EMP_STRATEGY_UTILITY_NOT_SET: "!(v1EMPStrategyUtility != address(0))",
		NOT_EMP_DEPLOYER: "!(v1EMPDeployer == msg.sender)",
		NOT_STRATEGY_DEPLOYER: "!(v1EMPStrategyDeployer == msg.sender)",
		ERC20_ADDRESS_ZERO: "!(_eRC20 != address(0))",
		ETH_VALUE_FEED_ADDRESS_ZERO: "!(_v1EMPERC20ETHValueFeed != address(0))",
	},
	EMP: {
		DEPOSIT_NOT_OPEN: "!utilizedERC20DepositOpen",
		INVALID_ALLOCATION: "!(utilizedV1EMPStrategyAllocationTotal == ONE_HUNDRED_PERCENT)",
	...
	STRATEGY: {
		DEPOSIT_NOT_OPEN: "!utilizedERC20DepositOpen",
		INTERACTOR_NOT_SET: "!(address(iV1EMPStrategyInteractor) != address(0))",
		...
		WITHDRAW_NOT_OPEN: "!utilizedERC20WithdrawOpen",
		ERC20_NO_ETH_VALUE_FEED_AVAILABLE: "!(I_V1_EMP_REGISTRY.eRC20_v1EMPERC20ETHValueFeed(__utilizedERC20[i]) != address(0))",
	},
