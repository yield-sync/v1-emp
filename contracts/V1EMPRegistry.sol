	...
	IV1EMPRegistry
{
	...
	function addressArrayUtilityUpdate(address __addressArrayUtility)
		...
		authGovernance()
	{
		require(__addressArrayUtility != address(0), "!__addressArrayUtility");
	...
	function eRC20_eRC20ETHValueProviderUpdate(address _eRC20, address _eRC20ETHValueProvider)
		...
		authGovernance()
	{
		require(_eRC20 != address(0), "!_eRC20");

		require(_eRC20ETHValueProvider != address(0), "!_eRC20ETHValueProvider");
	...
	function governanceUpdate(address __governance)
		...
		authGovernance()
	{
		require(__governance != address(0), "!__governance");
	...
	function percentUtilityUpdate(address __percentUtility)
		...
		authGovernance()
	{
		require(__percentUtility != address(0), "!__percentUtility");
	...
	function v1EMPDeployerUpdate(address __v1EMPDeployer)
		...
		authGovernance()
	{
		require(__v1EMPDeployer != address(0), "!__v1EMPDeployer");
	...
	function v1EMPStrategyDeployerUpdate(address __v1EMPStrategyDeployer)
		...
		authGovernance()
	{
		require(__v1EMPStrategyDeployer != address(0), "!__v1EMPStrategyDeployer");
	...
	function v1EMPStrategyUtilityUpdate(address __v1EMPStrategyUtility)
		...
		authGovernance()
	{
		require(__v1EMPStrategyUtility != address(0), "!__v1EMPStrategyUtility");
	...
	function v1EMPUtilityUpdate(address __v1EMPUtility)
		...
		authGovernance()
	{
		require(__v1EMPUtility != address(0), "!__v1EMPUtility");
